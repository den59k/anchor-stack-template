...
export const createApp = (opts?: FastifyServerOptions) => {
  ...
  app.register(fastifyStatic, { prefix: "/admin", root: path.resolve("./dist/frontend"), decorateReply: false })
  app.setNotFoundHandler((req, res) => res.sendFile("index.html", "./dist/frontend"))
